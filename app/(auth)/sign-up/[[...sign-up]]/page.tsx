      ...
      <main className="flex min-h-screen items-center justify-center bg-theme-bg px-4 py-16">
        <div className="w-full max-w-sm">
          <div className="bg-theme-surface border border-theme-border rounded-2xl p-8 shadow-xl text-center">
            ...
            <a href="/sign-in" className="text-theme-accent font-medium hover:underline cursor-pointer">
      ...
      <div className="w-full max-w-sm">
        <div className="bg-theme-surface border border-theme-border rounded-2xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium text-theme-muted mb-1.5">
                E-Mail
              </label>
              <input
                id="email"
            ...
            <div>
              <label htmlFor="username" className="block text-sm font-medium text-theme-muted mb-1.5">
                Benutzername
              </label>
              <input
                id="username"
              ...
              {usernameAvailable === false && !usernameError && (
                <p className="text-red-500 text-sm mt-1">Bereits vergeben</p>
              )}
            </div>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-theme-muted mb-1.5">
                Passwort bestätigen
              </label>
              <input
                id="confirmPassword"
